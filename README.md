...
1.1) What is the externally reachable attack surface of this software?
1.2) What are the major trust boundaries and privilege transitions in the system?
1.3) What are the most security-sensitive execution paths?
1.4) Which components are most likely to enable RCE, privilege escalation, or data exfiltration?
1.5) What logging, telemetry, or monitoring gaps could hide attacks?
1.6) What assumptions does the threat model rely on?
...
5.1) Which dependencies are security-critical, and why?
...
7.1) Which vulnerability classes are most likely in this codebase?
7.2) What vulnerability would you investigate first, and how would you validate it?
7.2) Where would you focus fuzzing or dynamic testing first?
8) Can the LLM give an example crashdump?
9) Can the LLM gove an example cookie?
